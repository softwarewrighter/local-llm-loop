...
- [docs/nvidia-5060-poc-summary.md](docs/nvidia-5060-poc-summary.md) — RTX 5060 Ti 16 GB (Blackwell/FP4) run: measured `llama-bench` across candidates; native MXFP4 prefill **beats the 3090** on gpt-oss-20b
